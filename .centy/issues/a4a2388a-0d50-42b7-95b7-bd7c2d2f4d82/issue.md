# feat(cockpit): Add batteries-included high-level API to cockpit library

## Summary

The `cockpit` library (centy-io/cockpit) currently provides low-level building blocks for terminal multiplexing. Developers must manually handle:
...
This will significantly simplify centy-tui's terminal multiplexer integration, reducing boilerplate and letting us focus on the TUI features rather than terminal plumbing.

## Related

- GitHub Issue: https://github.com/centy-io/cockpit/issues/2
- Future: Tab support for multiple layouts
